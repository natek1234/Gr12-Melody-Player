...
public class MelodyMain {
	...
	// Returns a NoteQueue filled with the notes specified in the provided
	// Scanner. The notes will appear in the same order in the NoteQueue
	// as they did in the file.
	public static NoteQueue read (Scanner input) {
		NoteQueue song = new NoteQueue();
